...
const allEmojis = [
  ...
  // Vault custom
  { id: 'vault_lock', native: '🔐', category: 'vault', name: 'Vault Lock' },
  { id: 'shield', native: '🛡️', category: 'vault', name: 'Shield' },
  { id: 'key_vault', native: '🗝️', category: 'vault', name: 'Key' },
  { id: 'envelope', native: '📨', category: 'vault', name: 'Envelope' },
  { id: 'locked', native: '🔒', category: 'vault', name: 'Locked' },
  { id: 'unlocked', native: '🔓', category: 'vault', name: 'Unlocked' },
  { id: 'eye', native: '👁️', category: 'vault', name: 'Eye' },
  { id: 'incognito', native: '🥷', category: 'vault', name: 'Incognito' },
  { id: 'hacker', native: '🕵️', category: 'vault', name: 'Hacker' },
  { id: 'fingerprint', native: '🖐️', category: 'vault', name: 'Fingerprint' },
  { id: 'vault', native: '🏦', category: 'vault', name: 'Vault' },
  { id: 'detective', native: '🕵️', category: 'vault', name: 'Detective' },
  { id: 'ninja', native: '🥷', category: 'vault', name: 'Ninja' },
  { id: 'ghost_vault', native: '👻', category: 'vault', name: 'Ghost' },
  { id: 'mask', native: '🎭', category: 'vault', name: 'Mask' },
  { id: 'lock_with_pen', native: '🔏', category: 'vault', name: 'Lock & Pen' },
  { id: 'key2', native: '🔑', category: 'vault', name: 'Key' },
  { id: 'ring', native: '💍', category: 'vault', name: 'Ring' },
  { id: 'gem', native: '💎', category: 'vault', name: 'Gem' },
  // Crypto
