...
1. Download
   [vault-0.1.145.apk](https://github.com/kmakan/vault/releases/download/v0.1.145/vault-0.1.145.apk)
   (21 MB, Android 7+) — also mirrored at
   `https://vault-msg.ru/releases/vault-0.1.145.apk`.
...
```bash
# Ubuntu/Debian
wget https://github.com/kmakan/vault/releases/download/v0.1.145/Vault_0.1.145_amd64.deb
sudo apt install ./Vault_0.1.145_amd64.deb

# Fedora/RHEL
sudo rpm -i Vault-0.1.145-1.x86_64.rpm
```

### Portable tar.gz (any distro)

```bash
wget https://vault-msg.ru/releases/vault-desktop-0.1.145-linux-x86_64.tar.gz
tar xzf vault-desktop-0.1.145-linux-x86_64.tar.gz
./vault-desktop
```
...
([v0.1.145](https://github.com/kmakan/vault/releases/tag/v0.1.145)):

```bash
sha256sum vault-0.1.145.apk
```
