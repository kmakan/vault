...
### 🚧 В работе (11.08)
- Группы через email — serverless (канбан t_ec173a7d + t_d005b7a7, взяты 11.08):
  CLI-ядро делегировано cline (group_key + /groupsend + раздача ключа через инвайт
  + приём/расшифровка), дальше Desktop-заглушки api.js и e2e на реальных Gmail
