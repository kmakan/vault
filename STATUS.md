...
- docs/research/calls-research-2026-08-22.md — сравнение реализаций (SimpleX X2TURN,
  ...
  сигнализация конвертами Vault через IMAP IDLE + TURN пользователя (X2TURN).
- docs/architecture/voice-calls.md — рерайт под решение (старая схема WebSocket+своя
  крипта фреймов устарела). ROADMAP M3 обновлён.
