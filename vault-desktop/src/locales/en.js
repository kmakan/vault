export default {
  ...
  duress_panic: "Panic code (wipes all data when entered)",
  ...
  voice_play: 'Play',
  voice_stop: 'Stop',
  voice_play_failed: 'Playback failed',
  ...
  relay_enable_hint: "Duplicates messages and calls for instant delivery (~1-2 sec). Email stays the primary channel: if the relay is unreachable, nothing is lost.",
  relay_auto: "Connect our relay",
  relay_renew: "Renew/refresh token",
  relay_have_promo: "I have an unlimited promo key",
  relay_promo_ph: "unlimited promo key (for testers)",
  relay_ntfy_step1: "1. Install the ntfy client:",
  relay_ntfy_step2: "2. Tap here to subscribe to notifications:",
  relay_advanced: "Advanced (own relay, peer tokens)",
  relay_list: "My relays",
  relay_base_url: "Relay URL (empty — our server)",
  relay_base_url_ph: "own relay: https://…",
  relay_delivery_email: " mail",
  ...
  relay_peer_tokens: "Peer tokens (email → read-token)",
  relay_peer_addr_ph: "peer email",
  relay_peer_token_ph: "their read-token",
  relay_add: "Add",
  relay_note: "The relay only duplicates envelopes for faster delivery; email remains the primary channel. A token is an anonymous subscription: no email, no message content.",
  duress_code_ph: "at least 4 characters",
  duress_optional: "optional",
  duress_err_short: "Unlock code: at least 4 characters",
  duress_err_same: "Codes must not match",
  duress_saved: "Duress protection saved",
  lock_title: "Vault is locked",
  lock_sub: "Enter your access code",
  lock_placeholder: "PIN or password",
  lock_wrong: "Wrong code",
  lock_bio: "Unlock with fingerprint",
  panic_done: "Data wiped",
  sos_default: "My phone is not with me{coords}",
  ...
  forward_err: 'Failed to forward',
  poll_create: 'Create poll',
  poll_question_ph: 'Question',
  poll_option_ph: 'Option',
  poll_add_option: '+ option',
  poll_send: 'Send',
  poll_err: 'Failed to send poll',
  poll_voted: 'voted',
  ...
  ignore_banner: 'Blocked — new messages are hidden',
  ignore_on_toast: 'Blocked: new messages and calls are hidden',
  ignore_off_toast: 'Unblocked',
  ignore_cannot_write: 'Chat is blocked — unblock first',
  ...
  channel_create_title: 'New Channel',
  channel_create_hint: 'A channel is a broadcast chat: you publish posts, subscribers only read and never see each other.',
  channel_create_failed: 'Could not create the channel',
  channel_created: 'Channel created — share the link',
  channel_name: 'Channel name',
  channel_about: 'Description',
  channel_join: 'Join Channel',
  channel_join_bad_link: 'Unrecognized channel link',
  channel_join_failed: 'Could not subscribe',
  channel_link_label: 'Channel link (vault://join-channel…)',
  ...
  chat_no_key: 'No key for this contact yet — exchange keys: press the link button «Add Contact» at the top of the chat list and enter the participant ID or scan the QR code.',
  contact_no_key_hint: 'No peer key yet — exchange keys (participant ID or QR)',
...
// General actions
  ...
  chat_starred: 'Starred messages',
  starred_empty: 'No starred messages',
  group_refresh: 'Refresh group',
  ...
  recovery_write_warning: 'Write down these 12 words in order. They are shown only once:',
  ...
  feedback_placeholder: 'Idea, bug, question… (sent to us via your own email)',
  feedback_send: 'Send feedback',
  feedback_sending: 'Sending…',
  feedback_sent: 'Thank you! Feedback sent.',
  feedback_err: 'Failed to send',
  update_error: 'Could not check for updates — server unreachable',
  settings_clear_warning: 'This will delete all local data: keys, chats, settings.',
  ...
  qr_copy: 'Copy',
  qr_id_hint: 'ID is your fingerprint. It does not change when you switch email (unlike the email address).',
  qr_show_qr: 'Show QR code (for Android / another device)',
  qr_scan_hint: 'Scan the code with a device running Vault — the key is added automatically.',
  qr_copy_key_summary: 'Copy key (send over any channel: messenger, SMS…)',
  qr_copy_key_btn: 'Copy key',
  qr_key_hint: 'The other person pastes it into the «Add key» field (step 3) — no email needed. The key is public: you can share it openly, it reveals nothing about your chats.',
  qr_step2_title: "Enter the other person's email",
  qr_email_ph: 'Their email',
  qr_send_request: 'Send request',
  qr_invite_hint: 'They will receive an invitation. Once accepted, the chat appears in the list.',
  qr_step3_title: 'Or paste the key from their QR code',
  qr_paste_ph: 'QR code content or key (hex)',
  qr_add_key: 'Add key',
  qr_paste_hint: 'Use this if they sent you their QR code or key.',
  qr_scanning: 'Scanning…',
  qr_scan_camera: 'Scan their on-screen QR code',
  qr_camera_hint: 'Point the camera at their QR code (or pick a photo with a QR) — the key is added automatically.',
  qr_bad_key: 'Invalid key format. Expected a 64-character hex string.',
  qr_process_err: 'Error processing QR code: ',
  qr_no_camera: 'No camera permission. Enable it in settings.',
  qr_not_found: 'No QR code found in the image. Try closer/sharper.',
  qr_scan_err: 'Scan error: ',
  qr_id_copied: 'Your ID is copied — send it to the other person',
  qr_key_copied: 'Public key copied — share it with the other person any way you like',
  // EmailSettings / App.vue / SettingsPage (i18n audit)
  email_del_account_confirm: 'Delete account? E2E keys are kept.',
  profile_photo_title: 'Profile photo',
  profile_photo_hint: 'Format: PNG, JPG, SVG. 100×100 px recommended.',
  profile_photo_choose: 'Choose file',
  ...
  group_avatar_hint: 'Click to upload a photo',
  change_email_new_ph: 'New email',
  change_email_pass_ph: 'App password / from external devices',
  change_email_connecting: 'Connecting…',
  change_email_btn: 'Change email',
  sos_text_ph: 'Phone is not with me{coords}',
  ephemeral_title: 'Disappearing messages',
  ephemeral_on_suffix: ': on ({ttl}), new messages will disappear',
  ephemeral_off_suffix: ' — off',
  profile_title_of: 'Profile {name}',
  email_keys_local_hint: 'E2E keys are stored locally. Changing email does not affect keys.',
  err_file_too_big_500: 'File too large (max 500KB)',
  err_file_too_big_2m: 'File too large (max 2MB)',
  err_notes_full: 'Local notes storage is full — the note was not saved.',
  err_group_key: 'Group key not loaded — reopen the group',
  err_enter_email: 'Enter the contact email',
  err_notes_full_voice: 'Local notes storage is full — voice message not saved. Delete some notes/attachments.',
  err_notes_full_file: 'Local notes storage is full — file not saved.',
  err_generic: 'Error: ',
}
