...
const props = defineProps({
  ...
  // Единый цвет иконок Vault (19.08): небесно-голубой #0ea5e9 — читается
  // на любой теме (яркий на тёмных, контрастный на светлой), отличается от
  // фиолетового логотипа. Логотип (V в шапке) остаётся фиолетовым.
