...
> Полное исследование и сравнение реализаций: `docs/research/calls-research-2026-08-22.md`.
...
Ни один публичный сервер установки/проведения звонка не требуется (ROADMAP M3, 18.08).
